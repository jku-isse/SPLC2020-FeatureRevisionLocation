  ...
  for(i=0; i<pTabList->nId; i++){
    ...
    if( pIdx==0 ){
      ...
      */
      ...
      sqliteVdbeAddOp(v, 31, pIdx->nField, 0, 0, 0);
...
void sqliteWhereEnd(WhereInfo *pWInfo){
  ...
  sqliteVdbeAddOp(v, 32, 0, pWInfo->iContinue, 0, 0);
  sqliteVdbeAddOp(v, 63, 0, 0, 0, pWInfo->iBreak);
  sqliteFree(pWInfo);
  return;
}
...
void sqliteExprCode(Parse *pParse, Expr *pExpr){
  ...
  int op;
  switch( pExpr->op ){
    case TK_PLUS:     op = 43;      break;
    case TK_MINUS:    op = 45; break;
    case TK_STAR:     op = 46; break;
    case TK_SLASH:    op = 47;   break;
    case TK_AND:      op = 59;      break;
    case TK_OR:       op = 60;       break;
    case TK_LT:       op = 52;       break;
    case TK_LE:       op = 53;       break;
    case TK_GT:       op = 54;       break;
    case TK_GE:       op = 55;       break;
    case TK_NE:       op = 51;       break;
    case TK_EQ:       op = 50;       break;
    case TK_ISNULL:   op = 56;   break;
    case TK_NOTNULL:  op = 57;  break;
    case TK_NOT:      op = 61;      break;
    case TK_UMINUS:   op = 58; break;
    default: break;
  }
  switch( pExpr->op ){
    case TK_FIELD: {
    ...
    case TK_INTEGER: {
      ...
      sqliteVdbeAddOp(v, 38, i, 0, 0, 0);
      break;
    }
    case TK_FLOAT: {
      int addr = sqliteVdbeAddOp(v, 39, 0, 0, 0, 0);
...
void sqliteExprIfTrue(Parse *pParse, Expr *pExpr, int dest){
  ...
  switch( pExpr->op ){
    ...
    default: {
      ...
      sqliteVdbeAddOp(v, 33, 0, dest, 0, 0);
      break;
    }
  }
}
...
void sqliteExprIfFalse(Parse *pParse, Expr *pExpr, int dest){
  ...
  int op = 0;
  switch( pExpr->op ){
    case TK_LT:       op = 55;       break;
    case TK_LE:       op = 54;       break;
    case TK_GT:       op = 53;       break;
    case TK_GE:       op = 52;       break;
    case TK_NE:       op = 50;       break;
    case TK_EQ:       op = 51;       break;
    case TK_ISNULL:   op = 57;  break;
    case TK_NOTNULL:  op = 56;   break;
    default:  break;
  }
  switch( pExpr->op ){
    case TK_AND: {
