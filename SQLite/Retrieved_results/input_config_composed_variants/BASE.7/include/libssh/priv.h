...
typedef struct ssh_crypto_struct {
    bignum e,f,x,k,y;
    char session_id[SHA_DIGEST_LENGTH];
    
    char encryptIV[SHA_DIGEST_LENGTH*2];
    char decryptIV[SHA_DIGEST_LENGTH*2];

    char decryptkey[SHA_DIGEST_LENGTH*2];
    char encryptkey[SHA_DIGEST_LENGTH*2];

    char encryptMAC[SHA_DIGEST_LENGTH];
    char decryptMAC[SHA_DIGEST_LENGTH];
