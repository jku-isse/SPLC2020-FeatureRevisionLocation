...
typedef struct ssh_crypto_struct {
    ...
    unsigned char encryptIV[20*2];
    unsigned char decryptIV[20*2];

    unsigned char decryptkey[20*2];
    unsigned char encryptkey[20*2];

    unsigned char encryptMAC[20];
    unsigned char decryptMAC[20];
    unsigned char hmacbuf[36];
