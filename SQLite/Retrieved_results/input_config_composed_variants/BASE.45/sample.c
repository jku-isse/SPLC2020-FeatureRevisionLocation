...
int main(int argc, char **argv){
    ...
    switch(state){
        ...
        case 2:
            ...
            ssh_print_hexa("Public key hash",hash,16);
    ...
    if(auth!=0){
        ...
        if(ssh_userauth_password(session,NULL,password) != 0){
