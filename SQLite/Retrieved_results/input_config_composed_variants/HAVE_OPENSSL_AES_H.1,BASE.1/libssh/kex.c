...
char *default_methods[]={
	"diffie-hellman-group1-sha1","ssh-dss,ssh-rsa","aes256-cbc,aes192-cbc,aes128-cbc," "" "3des-cbc,","aes256-cbc,aes192-cbc,aes128-cbc," ""
...
static void build_session_id1(SSH_SESSION *session, STRING *servern, 
    ...
    ssh_print_hexa("session_id",session->next_crypto->session_id,MD5_DIGEST_LENGTH);
}
