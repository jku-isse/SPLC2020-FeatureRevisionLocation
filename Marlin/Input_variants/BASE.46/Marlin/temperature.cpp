...
ISR(TIMER0_COMPB_vect)
{
  ...
  switch(temp_state) {
    ...
    case 5: // Measure TEMP_2
      ...
      break;
    default:
      Serial << "Error: " << "Temp measurement error!"<<endl;;
      break;
  }
  ...
  if(temp_count >= 16) // 6 ms * 16 = 96ms.
  {
    ...
    raw_temp_2_value = 0;
        ...
        if(current_raw[TEMPSENSOR_HOTEND_0] >= maxttemp_0) {
          ...
          analogWrite(2, 0);
          Serial << "Error: " << "Temperature extruder 0 switched off. MAXTEMP triggered !!"<<endl;;
          kill();
        }
      ...
      if(current_raw[TEMPSENSOR_HOTEND_0] <= minttemp_0) {
        target_raw[TEMPSENSOR_HOTEND_0] = 0;
        analogWrite(2, 0);
        Serial << "Error: " << "Temperature extruder 0 switched off. MINTEMP triggered !!"<<endl;;
        kill();
      }
