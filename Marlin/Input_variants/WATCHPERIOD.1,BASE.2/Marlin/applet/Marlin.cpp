...
{ 
  while( Serial.available() > 0  && buflen < 8) {
    serial_char = Serial.read();
    if(serial_char == '\n' || serial_char == '\r' || serial_char == ':' || serial_count >= (96 - 1) ) 
    {
...
static block_t block_buffer[16];            // A ring buffer for motion instructions
...
void planner_forward_pass() {
  ...
  while(block_index != block_buffer_head) {
    ...
    block_index = (block_index+1) & 0x0f;
  }
...
inline void plan_discard_current_block() {
  if (block_buffer_head != block_buffer_tail) {
    block_buffer_tail = (block_buffer_tail + 1) & 0x0f;  
  }
}
...
void plan_buffer_line(float x, float y, float z, float e, float feed_rate) {
  ...
  int next_buffer_head = (block_buffer_head + 1) & 0x0f;	
...
inline unsigned short calc_timer(unsigned short step_rate) {
  ...
  if(step_rate > (8*256)){ // higher step rate 
    ...
    asm volatile ( "clr r26 \n\t" "mul %A1, %B2 \n\t" "movw %A0, r0 \n\t" "mul %A1, %A2 \n\t" "add %A0, r1 \n\t" "adc %B0, r26 \n\t" "lsr r0 \n\t" "adc %A0, r26 \n\t" "adc %B0, r26 \n\t" "clr r1 \n\t" : "=&r" (timer) : "d" (tmp_step_rate), "d" (gain) : "r26" , "r27" );
...
{        
  ...
  if (current_block != NULL) {
    ...
    if (step_events_completed < accelerate_until) {
      asm volatile ( "clr r26 \n\t" "mul %A1, %B2 \n\t" "mov r27, r1 \n\t" "mul %B1, %C2 \n\t" "movw %A0, r0 \n\t" "mul %C1, %C2 \n\t" "add %B0, r0 \n\t" "mul %C1, %B2 \n\t" "add %A0, r0 \n\t" "adc %B0, r1 \n\t" "mul %A1, %C2 \n\t" "add r27, r0 \n\t" "adc %A0, r1 \n\t" "adc %B0, r26 \n\t" "mul %B1, %B2 \n\t" "add r27, r0 \n\t" "adc %A0, r1 \n\t" "adc %B0, r26 \n\t" "mul %C1, %A2 \n\t" "add r27, r0 \n\t" "adc %A0, r1 \n\t" "adc %B0, r26 \n\t" "mul %B1, %A2 \n\t" "add r27, r1 \n\t" "adc %A0, r26 \n\t" "adc %B0, r26 \n\t" "lsr r27 \n\t" "adc %A0, r26 \n\t" "adc %B0, r26 \n\t" "clr r1 \n\t" : "=&r" (acc_step_rate) : "d" (acceleration_time), "d" (acceleration_rate) : "r26" , "r27" );
      acc_step_rate += initial_rate;
      ...
      asm volatile ( "clr r26 \n\t" "mul %A1, %B2 \n\t" "mov r27, r1 \n\t" "mul %B1, %C2 \n\t" "movw %A0, r0 \n\t" "mul %C1, %C2 \n\t" "add %B0, r0 \n\t" "mul %C1, %B2 \n\t" "add %A0, r0 \n\t" "adc %B0, r1 \n\t" "mul %A1, %C2 \n\t" "add r27, r0 \n\t" "adc %A0, r1 \n\t" "adc %B0, r26 \n\t" "mul %B1, %B2 \n\t" "add r27, r0 \n\t" "adc %A0, r1 \n\t" "adc %B0, r26 \n\t" "mul %C1, %A2 \n\t" "add r27, r0 \n\t" "adc %A0, r1 \n\t" "adc %B0, r26 \n\t" "mul %B1, %A2 \n\t" "add r27, r1 \n\t" "adc %A0, r26 \n\t" "adc %B0, r26 \n\t" "lsr r27 \n\t" "adc %A0, r26 \n\t" "adc %B0, r26 \n\t" "clr r1 \n\t" : "=&r" (step_rate) : "d" (deceleration_time), "d" (acceleration_rate) : "r26" , "r27" );
