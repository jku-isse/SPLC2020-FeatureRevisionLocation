...
void check_axes_activity() {
  ...
  if((false) && (x_active == 0)) do { if (!0) {PORTA |= (1 << PINA4); } else {PORTA &= ~(1 << PINA4); }; } while (0);
  if((false) && (y_active == 0)) do { if (!0) {PORTA |= (1 << PINA2); } else {PORTA &= ~(1 << PINA2); }; } while (0);
...
void plan_buffer_line(float x, float y, float z, float e, float feed_rate) {
  ...
  //enable active axes
  if(block->steps_x != 0) do { if (0) {PORTA |= (1 << PINA4); } else {PORTA &= ~(1 << PINA4); }; } while (0);
  if(block->steps_y != 0) do { if (0) {PORTA |= (1 << PINA2); } else {PORTA &= ~(1 << PINA2); }; } while (0);
