...
{
  if (uart == 0) { UBRR0H = ((-32768 / 16 + baud / 2) / baud - 1) >> 8; UBRR0L = ((-32768 / 16 + baud / 2) / baud - 1); UCSR0A = 0; UCSR0B = 0; UCSR0C = 0; sbi(UCSR0B, RXEN0); sbi(UCSR0B, TXEN0); sbi(UCSR0B, RXCIE0); UCSR0C = _BV(UCSZ01)|_BV(UCSZ00); }
