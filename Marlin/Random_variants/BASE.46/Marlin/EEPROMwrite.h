...
void StoreSettings() 
{
  ...
  serialprintPGM(PSTR("echo: Settings Stored\n"));
}
...
{  // if def=true, the default values will be used
  ...
  {   // version number match
    ...
    serialprintPGM(PSTR("echo: Stored settings retreived:\n"));
  }
  else 
  {
    ...
    max_xy_jerk=30.0*60;
    max_z_jerk=10.0*60;
    serialprintPGM(PSTR("echo: Using Default settings:\n"));
  }
  serialprintPGM(PSTR("echo: Steps per unit:\n   M92 X"));
    Serial.print(axis_steps_per_unit[0]);
    serialprintPGM(PSTR(" Y")); 
    Serial.print(axis_steps_per_unit[1]);
    serialprintPGM(PSTR(" Z"));
    Serial.print(axis_steps_per_unit[2]);
    serialprintPGM(PSTR(" E"));
  ...
  serialprintPGM(PSTR("   M205 S"));
    ...
    serialprintPGM(PSTR("PID settings:"));
    serialprintPGM(PSTR("   M301 P")); 
    Serial.print(Kp ); 
    serialprintPGM(PSTR(" I")); 
    Serial.print(Ki ); 
    serialprintPGM(PSTR(" D")); 
    Serial.print(Kd);  
