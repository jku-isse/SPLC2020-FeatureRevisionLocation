...
static unsigned long previous_millis_heater, previous_millis_bed_heater;
  ...
  static int minttemp_1 = temp2analog(1);
...
ISR(TIMER0_COMPB_vect)
{
  ...
  switch(temp_state) {
    ...
    default:
      ...
      {serialprintPGM(PSTR("Temp measurement error!"));Serial.write('\n');};
      break;
  }
  ...
  if(temp_count >= 16) // 6 ms * 16 = 96ms.
  {
    ...
    raw_temp_2_value = 0;
        ...
        if(current_raw[TEMPSENSOR_HOTEND_0] >= maxttemp_0) {
          ...
          analogWrite(2, 0);
          serialprintPGM(errormagic);;
          {serialprintPGM(PSTR("Temperature extruder 0 switched off. MAXTEMP triggered !!"));Serial.write('\n');};
          kill();
        }
      ...
      if(current_raw[TEMPSENSOR_HOTEND_0] <= minttemp_0) {
        ...
        analogWrite(2, 0);
        serialprintPGM(errormagic);;
        {serialprintPGM(PSTR("Temperature extruder 0 switched off. MINTEMP triggered !!"));Serial.write('\n');};
        kill();
      }
      ...
      if(current_raw[TEMPSENSOR_HOTEND_1] <= minttemp_1) {
        ...
        analogWrite(51, 0);
        serialprintPGM(errormagic);;
        {serialprintPGM(PSTR("Temperature extruder 1 switched off. MINTEMP triggered !!"));Serial.write('\n');};
        kill();
      }
