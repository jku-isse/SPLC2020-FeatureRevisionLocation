  ...
  if(temp_count >= 16) // 6 ms * 16 = 96ms.
  {
    ...
    raw_temp_2_value = 0;
      ...
      if(current_raw[2] >= maxttemp_1) {
        analogWrite(51, 0);
        Serial << "echo: ERROR: " << "Temperature extruder 1 switched off. MAXTEMP triggered !!"<<endl;;
        kill()
      }
      ...
      if(current_raw[TEMPSENSOR_HOTEND_1] <= minttemp_1) {
        target_raw[TEMPSENSOR_HOTEND_1] = 0;
        analogWrite(51, 0);
        Serial << "echo: ERROR: " << "Temperature extruder 1 switched off. MINTEMP triggered !!"<<endl;;
        kill();
      }
